...
{
    /**
     * Construct the RandomSentence generator.
     */
    ...
    )
    {
        ...
        try {
            ...
            Log.e(MainActivity.ProjectName,"Rewrite parse error: " + e.toString());
        }
        catch (NumberFormatException e) {
            Log.e(MainActivity.ProjectName,"Corrupted rule rewrite \n" + rule);
            Log.e(MainActivity.ProjectName,"Weight format error: " + e.toString());
        }
        return (result);
    }
    ...
    )
    {
        ...
        try {
            ...
            work.append(", rule is \"" + work.toString() + "\"");
        }
        catch (IOException e) {
            work.append(" (" + e.toString() + ")");
        }
